...
# modified from OPENSELFSUP:https://github.com/open-mmlab/OpenSelfSup
import torch
from torch import nn, optim
from torch.optim.optimizer import Optimizer, required
from torch.optim import *

class LARS_OPENSELF(Optimizer):
    ...
    def __init__(self,
        ...
        super(LARS_OPENSELF, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(LARS_OPENSELF, self).__setstate__(state)
